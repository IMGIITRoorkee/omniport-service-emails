...
<body style="align-items: center; height: auto; position: relative; width: 100%; font-weight: normal; font-family: Roboto; font-style: normal;">
    ...
    color: #FFFFFF;
    padding: 0.15em 0;font-size: 14px;
    display: table-cell;
    vertical-align: middle;"><a href='TargetURL/Text' style="color:#F8D16C; text-decoration:none;">TargetApp/Text</a></span>
            </div>
        </div>
    </div>
...
display: table-cell;
padding: 18px;">
            <div class='post1' style='font-size: 14px;color: #293B52;'><b>Posted By:</b> Sender/Text</div>
            <div class='post2' style="font-size: 14px;
color: #293B52;"><b>Posted On:</b> Time/Text</div>
        </div>
    </div>
...
height: auto;
font-size: 14px;
max-width: 1400px;">Body/Text</div>
        </div>
    </div>
    <div class='table bottom' style="width: 100%; position: relative; display: table; height: 100px; background: #293B52; font-size: 14px;">
    ...
    padding: 0;">
            <div class='table bottom2' style="width: 100%; position: relative; display: table;">
                <div class='row bottom3' style="vertical-align: middle; display: table-cell; padding: 0 18px;">
                    <div class='email' style="margin-top: 4px; margin-bottom: 4px;"><b>Email: <a href="mailto:MaintainerMail/Text" style="color:#F8D16C; text-decoration: none;">MaintainerMail/Text</a></b></div>
                    <div class='phone' style="margin-top: 4px; margin-bottom: 4px; "><b>Phone: <a href="tel:+MaintainerPhone/Text" style="color:#F8D16C; text-decoration: none;">MaintainerPhone/Text</a></b></div>
                    <div class='follow' style="margin-top: 4px; margin-bottom: 4px;"><b>Follow us on: <a href="FacebookLink/Text" style="color:#F8D16C; text-decoration: none;">FacebookSite/Text &ensp;</a> <a href="MediumLink/Text" style="color:#F8D16C; text-decoration: none;">MediumSite/Text &ensp;</a> <a href="InstagramLink/Text" style="text-decoration: none; color: #F8D16C">InstagramSite/Text</a></b></div>
                </div>
                <div class='logo' style="position: relative; float: right; display: table-cell; vertical-align: middle;padding-right: 2rem">
